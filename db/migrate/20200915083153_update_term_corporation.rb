class UpdateTermCorporation < ActiveRecord::Migration[5.2]
  def change
    ...
    '
    <ol>
    <li>Kami (PT. Otoraja Network Indonesia) menyediakan layanan platform dan/atau
    ...
    <li>Anda memiliki hak-hak tertentu sehubungan dengan pemrosesan Data Pribadi Anda yang kami lakukan.
      ...
      Nama perusahaan yang melakukan percobaan: PT. Otoraja Network Indonesia<br>
      Alamat surel (e-mail): sales@otoraja.co.id<br>
    </li>
