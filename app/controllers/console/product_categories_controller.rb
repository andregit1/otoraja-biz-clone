class Console::ProductCategoriesController < Console::ApplicationConsoleController
  ...
  def create
    ...
    if @product_category.save
      redirect_to console_product_categories_path, notice: 'Product category was successfully created.' 
    else
      render :new
    end
  end
  ...
  def update
    ...
    if @product_category.save
      redirect_to console_product_categories_path, notice: 'Product category was successfully updated.'
    else
      render :edit
    end
  end
